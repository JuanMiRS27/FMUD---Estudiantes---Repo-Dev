...
despues de una respuesta temporal, durante un maximo de 5 minutos. No hay tareas
...
- Los tres servicios: Build Filters > Ignored Paths = `frontend/**`. Los cambios
  exclusivos de la interfaz no deben reconstruir los microservicios.
