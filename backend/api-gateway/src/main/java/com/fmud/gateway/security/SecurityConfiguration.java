...
public class SecurityConfiguration {
    @Bean
    SecurityFilterChain securityFilterChain(HttpSecurity http, JwtTokenValidator validator, ObjectMapper mapper, GatewayProperties properties) throws Exception {
